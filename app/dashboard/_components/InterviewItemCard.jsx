// "use client";
// import { Button } from "@/components/ui/button"; // Ensure this path matches your setup
...
// 	return (
// 		<div
// 			className={`border shadow-md rounded-lg p-4 transition-all duration-300 ${
// 				hovered ? "bg-gray-50 scale-105" : "bg-white"
// 			}`}
...
// 				Created At:{" "}
// 				{new Date(interviewInfo.createdAt).toLocaleDateString()}
// 			</p>
