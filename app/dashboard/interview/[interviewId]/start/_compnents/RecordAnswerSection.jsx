...
// 	useEffect(() => {
// 		// Trigger DB update on user answer change
...
// 	const UpdateUserAnswerInDb = async () => {
// 		console.log("Starting to update user answer in DB...");
// 		setLoading(true);

// 		// Construct feedback prompt
// 		const feedbackPromt = `Question: ${mockInterViewQuestion[activeQuestionIndex]?.question}, User Answer: ${userAnswer}. Based on the question and the user's answer, please provide a rating 1 to 10 for the answer and feedback in the form of areas for improvement, if any. The feedback should be in JSON format only nothing else field should be rating and feedback only, in just 3 to 5 lines.`;

// 		// Send to AI model
// 		console.log("Sending feedback prompt:", feedbackPromt);
// 		const result = await chatSession.sendMessage(feedbackPromt);
...
// 				console.log("User answer saved successfully in DB.");
// 				setUserAnswer("");
// 				setResults([]);
// 			}
// 		} catch (error) {
// 			console.error("Error parsing AI response or saving to DB:", error);
